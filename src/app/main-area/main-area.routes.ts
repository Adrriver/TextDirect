...
const mainRoutes: Routes = [
  {
    ...
    children: [
        ...
        { path: 'orderDetail/:id', component: OrderDetailComponent, canActivateChild: [AuthGuardService] },
        { path: 'priceRepDetail/:id', component: PriceReportDetailComponent, canActivateChild: [AuthGuardService] },
        { path: 'saleDetail/:id', component: SaleDetailComponent, canActivateChild: [AuthGuardService] },
